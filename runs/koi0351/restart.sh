...
then
  ...
  then
    ...
    echo mpirun -np 200 -output-filename outf/sbatch.o --tag-output ../../src/demcmc $INFILE empty.txt $RESTARTF $RESTARTBSQ $RESTARTGAMMA >> $RESTARTSBATCH 
  else 
    echo mpirun -np 200 -output-filename outf/sbatch.o --tag-output ../../src/demcmc $INFILE empty.txt -rv0=$RVFILE0 $RESTARTF $RESTARTBSQ $RESTARTGAMMA >> $RESTARTSBATCH 
  ...
  echo mpirun -np 200 -output-filename outf/sbatch.o --tag-output ../../src/demcmc $INFILE empty.txt -rv0=$RVFILE0 -rv1=$RVFILE1 $RESTARTF $RESTARTBSQ $RESTARTGAMMA >> $RESTARTSBATCH 
fi
